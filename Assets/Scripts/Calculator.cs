...
namespace Test
{
    // Основной класс, с помощью которого производятся вычисления данного выражения
    // Вычисления производятся с помощбю метода обратной польской записи (постпрефиксной записи)
    static class Calculator
    {
        ...
        static public string Calculate(string input)
        {
            ...
            return Counting(output).ToString(); //Решаем полученное выражение и возвращаем результат
        }
